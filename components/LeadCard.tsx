...
export function LeadCard({ lead }: { lead: Lead }) {
  return (
    <article className="surface-secondary glass-button rounded-[20px] p-5 transition hover:-translate-y-0.5">
      ...
      <div className="mt-4 rounded-[18px] border border-white/6 bg-slate-950/35 p-4">
